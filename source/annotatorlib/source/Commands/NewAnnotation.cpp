...
AnnotatorLib::Commands::NewAnnotation::NewAnnotation(std::string newObjectName, AnnotatorLib::Frame *frame, float x, float y, float hradius, float vradius, AnnotatorLib::Session *session, bool isLast = false)
{
...
AnnotatorLib::Commands::NewAnnotation::NewAnnotation(Object *object, Frame *frame, float x, float y, float hradius, float vradius,
...
AnnotatorLib::Commands::NewAnnotation::NewAnnotation(AnnotatorLib::Object *object, AnnotatorLib::Frame *frame,
                                                     float x, float y, float hradius, float vradius,
                                                     AnnotatorLib::Annotation *next, AnnotatorLib::Annotation *previous,
...
AnnotatorLib::Annotation *AnnotatorLib::Commands::NewAnnotation::getAnnotation()
{
    return annotation;
}
