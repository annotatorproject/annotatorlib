...
void JSONSaver::setPath(std::string path)
{
    this->path = path;
}

StorageType JSONSaver::getType()
{
...
QJsonObject JSONSaver::attributeToJson(Attribute *attribute)
{
    ...
    json["type"] = QString::fromStdString(AnnotatorLib::AttributeTypeToString(attribute->getType()));
    json["default"] = QString::fromStdString(attribute->getDefaultValue()->toString());
    return json;
}
...
QJsonObject JSONSaver::annotationToJson(Annotation *annotation)
{
    ...
    json["hradius"] = QString::number(annotation->getHRadius());
    json["vradius"] = QString::number(annotation->getVRadius());
    json["type"] = QString::fromStdString(AnnotatorLib::AnnotationTypeToString(annotation->getType()));
