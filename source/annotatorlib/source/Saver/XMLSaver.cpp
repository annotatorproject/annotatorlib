...
Poco::AutoPtr<Poco::XML::Element> XMLSaver::meta(const shared_ptr<Frame> frame) {
    Poco::AutoPtr<Poco::XML::Element> element = document->createElement("META");
    Poco::AutoPtr<Poco::XML::Element> filename = document->createElement("FILENAME");
...
Poco::AutoPtr<Poco::XML::Element> XMLSaver::fromObject(const Session *session,
    ...
    name->appendChild(
                document->createTextNode(object->getName()));
    element->appendChild(name);
    // OBJ_COLOR
    Poco::AutoPtr<Poco::XML::Element> obj_name = document->createElement("OBJ_COLOR");
